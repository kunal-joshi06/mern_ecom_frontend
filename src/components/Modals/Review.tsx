    ...
    return (
        <>
            <button onClick={handleModal}><div className="cursor-pointer relative inline-flex items-center justify-center p-4 px-6 py-3 overflow-hidden font-medium text-zinc-800 transition duration-300 ease-out border-2 border-rose-500 rounded-full shadow-md group">
                ...
                <span className="absolute flex items-center justify-center w-full h-full cta-text transition-all duration-400 transform group-hover:translate-x-full ease">Review</span>
                                                ...
                                                <form className="w-full max-w-lg mt-4" onSubmit={handleSubmit(onSubmit)}>
                                                    <div className=" -mx-3 mb-6">
                                                        <div className="w-full px-3 mb-6">
                                                            ...
                                                            {errors.rating && <span className='text-sm text-red-600'>This field is required</span>}
                                                        </div>
                                                        <div className="w-full  px-3 mb-6">
                                                            ...
                                                            {errors.comment && <span className='text-sm text-red-600'>This field is required</span>}
                                                        </div>
